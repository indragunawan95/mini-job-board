...
export default function ViewDetailJobPage() {
  ...
  const fetchJobDetails = useCallback(async () => {
    ...
    ] = await Promise.all([userPromise, jobPromise]);
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-80">
                        ...
                        {getCountryName(job.location_country)}
                      </p>
                    </div>
                  </li>
                  <li className="flex items-center gap-3">
                ...
                {isOwner && (
                  <>
                    ...
                    <div className="card-actions justify-stretch flex-col gap-2">
                      <Link href={`/jobs/${job.id}/edit`} className="btn btn-secondary w-full">
                        Edit Job
                      </Link>
                      <button onClick={handleDelete} className="btn btn-error btn-outline w-full">
                        Delete Job
                      </button>
                    </div>
                  </>
